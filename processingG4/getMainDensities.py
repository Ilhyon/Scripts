...
def main(path):
    ...
    pG4rFileShuf = path + sp + '/pG4r_shuffle.csv'
    pG4rFileWtpreRNA = path + sp + '/' + ini + 'pG4.txt'
	pG4rFileWtMatureRNA = path + sp + '/' + ini + 'pG4Mature.txt'
...
def build_arg_parser():
	...
	parser.add_argument ('-sp', '--species', default = 'yersinia_pestis_biovar_microtus_str_91001')
    return parser
